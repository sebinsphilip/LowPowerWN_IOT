...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <transmitting_range>47.0</transmitting_range>
      <interference_range>47.0</interference_range>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>116.10306754674518</x>
        <y>-15.81224076364957</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>105.94812868512128</x>
        <y>2.88443647325731</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>81.84344558283223</x>
        <y>32.20041723918965</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.05138185510091</x>
        <y>22.003398071310265</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>15.632900607866155</x>
        <y>14.595618584474355</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-23.518281065954945</x>
        <y>17.31979499276289</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-31.008736630772688</x>
        <y>54.19424739492283</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-10.106942793249214</x>
        <y>84.40648428756965</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>14.824653573285516</x>
        <y>112.79253291590135</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.99793540423503</x>
        <y>118.4517164261251</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.948800477788966 0.0 0.0 1.948800477788966 93.14701896472552 81.17554819815399</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>SIM_SETTLING_TIME = 1000
        ...
        outputs = new FileWriter("test_udgm_line_nogui.log");
        dcoutputs = new FileWriter("test_udgm_line_nogui_dc.log");
