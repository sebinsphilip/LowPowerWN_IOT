...
<simconf>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.3505050505050505 0.0 0.0 0.3505050505050505 34.27272727272728 15.272727272727284</viewport>
    </plugin_config>
    <width>398</width>
    <z>5</z>
    <height>554</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>SIM_SETTLING_TIME = 1000
        ...
        outputs = new FileWriter("test_nogui_mrm_line.log");
        dcoutputs = new FileWriter("test_nogui_mrm_line_dc.log");
